...
"""
   ...
   buildTree(x, y, depth; max_depth, min_gain, min_records, max_features, infoGain, splitting_criterion, force_classification)
...
- `infoGain`: Gain function to be used together with splitting_criterion.
